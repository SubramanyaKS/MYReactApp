        ...
        <div className="container-fluid ">
            ...
            <div className="col mb-4  d-flex align-items-stretch">
                ...
                <div className="card-body">
                    ...
                    <div className="social-buttons mt-5"><a href="https://github.com/SubramanyaKS/busreservation"> <button className="neo-button"><FontAwesomeIcon icon={faCoffee} /> </button></a></div>
                </div>
                </div>
            </div>
            <div className="col mb-4  d-flex align-items-stretch">
                ...
                <div className="card-body">
                    ...
                    <div className="social-buttons mt-5"><a href="https://github.com/SubramanyaKS/Diabetes_prediction"> <button className="neo-button"><i className="fab fa-github" /> </button></a></div>					
                </div>
                </div>
            </div>
            <div className="col mb-4  d-flex align-items-stretch">
                ...
                <div className="card-body">
                    ...
                    {/*<a href="https://github.com/SubramanyaKS/Heart_Attack_Prediction" class="btn btn-primary">Project link</a>
                            <a href="https://heart-attack-prediction-model.herokuapp.com/" class="btn btn-primary">Deployed Link</a>*/}
                    <div className="social-buttons mt-5"><a href="https://github.com/SubramanyaKS/Heart_Attack_Prediction"> <button className="neo-button"><i className="fab fa-github" /> </button></a><a href="https://heart-attack-prediction-model.herokuapp.com/"> <button className="neo-button"><i className="fas fa-share-square" style={{fontSize: '24px'}} /> </button></a></div>					
                </div>
                </div>
            </div>
            <div className="col mb-4  d-flex align-items-stretch">
                ...
                <div className="card-body">
                    ...
                    <div className="social-buttons mt-5"><a href="https://github.com/SubramanyaKS/VTU-CGPA_SGPA-Calculator/"> <button className="neo-button"><i className="fab fa-github" /> </button></a><a href="https://github.com/SubramanyaKS/VTU-CGPA_SGPA-Calculator/blob/main/VTU_SGPA_CGPA.jar"> <button className="neo-button"><i className="fas fa-download" style={{fontSize: '24px'}} /></button></a></div>		
                </div>
                </div>
            </div>
            <div className="col mb-4  d-flex align-items-stretch">
                ...
                <div className="card-body">
                    ...
                    <div className="social-buttons mt-5"><a href="https://github.com/SubramanyaKS/MediaPlayer-Android-Application"> <button className="neo-button"><i className="fab fa-github" /> </button></a></div>
                </div>
                </div>
            </div>
            <div className="col mb-4  d-flex align-items-stretch">
                ...
                <div className="card-body">
                    ...
                    <div className="social-buttons mt-5"><a href="https://github.com/SubramanyaKS/W
                    eatherProject/"> </a><button className="neo-button"><a href="https://github.com/SubramanyaKS/W
                    eatherProject/"><i className="fab fa-github" /> </a></button></div>				
                </div>
                </div>
            </div>
            </div>
